                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
<?php echo form_open_multipart('c_halte/simpan');?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                       
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="nama_halte" placeholder="Nama Halte" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="alamat_halte" placeholder="Alamat Halte" />
                                        </div>
                                    </div>
                                 ...
                                 <input type="file" name="userfile" size="20" />
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="latitute" placeholder="Latitute" id="latitude" />
                                        </div>
                                    </div>
                                        
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="longtitude" placeholder="Longtitude" id="longitude" />
                                        </div>
                                    </div>
